    ...
    <header id="header" className="header">
            <div className="top-left">
                <div className="navbar-header">
                    ...
                    <a className="navbar-brand hidden" href="./"><img src={require('.././images/logo2.png')} alt="Logo" /></a>
                    <a href="mitra.cash" id="menuToggle" className="menutoggle"><i className="fa fa-bars"></i></a>
                </div>
            </div>
            <div className="top-right">
                <div className="header-menu">
                    <div className="header-left">
                        ...
                        <div className="dropdown for-notification">
                            ...
                            <div className="dropdown-menu" aria-labelledby="notification">
                                ...
                                <a className="dropdown-item media" href="mitra.cash">
                        ...
                        <div className="dropdown for-message">
                            ...
                            <div className="dropdown-menu" aria-labelledby="message">
                                ...
                                <a className="dropdown-item media" href="mitra.cash">
                                    <span className="photo media-left"><img alt="avatar" src={require('.././images/avatar/1.jpg')} /></span>
                                ...
                                <a className="dropdown-item media" href="mitra.cash">
                                    <span className="photo media-left"><img alt="avatar" src={require('.././images/avatar/2.jpg')} /></span>
                                    <div className="message media-body">
                                ...
                                <a className="dropdown-item media" href="mitra.cash">
                                    <span className="photo media-left"><img alt="avatar" src={require('.././images/avatar/3.jpg')} /></span>
                                    <div className="message media-body">
                                ...
                                <a className="dropdown-item media" href="mitra.cash">
                                    <span className="photo media-left"><img alt="avatar" src={require('.././images/avatar/4.jpg')} /></span>
                                    <div className="message media-body">
                    ...
                    <div className="user-area dropdown float-right">
                        <a href="mitra.cash" className="dropdown-toggle active" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <img className="user-avatar rounded-circle" src={require('.././images/admin.jpg')} alt="User Avatar" />
                        </a>

                        <div className="user-menu dropdown-menu">
                            <a className="nav-link" href="mitra.cash"><i className="fa fa- user"></i>My Profile</a>

                            <a className="nav-link" href="mitra.cash"><i className="fa fa- user"></i>Notifications <span className="count">13</span></a>

                            <a className="nav-link" href="mitra.cash"><i className="fa fa -cog"></i>Settings</a>

                            <a className="nav-link" href="mitra.cash"><i className="fa fa-power -off"></i>Logout</a>
                        </div>
                    </div>
