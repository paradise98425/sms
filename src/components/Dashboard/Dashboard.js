...
class Dashboard extends Component {
    ...
    constructor(props){
        ...
        // bind any function declared below  
    }

    // using componentWillMount method to check the authenticity of the user 
    componentWillMount(){
        if(localStorage.getItem('access')){
            // send the token to verify if it is not yet expired
            VerifyToken('verify', localStorage.getItem('access'))
            .then(
                (access_response) => {
                    let access_result = access_response;
                    // if this response has some details with it, then the token is expired 
                    if(access_result.detail){
                        // check if there is refresh token
                        if(localStorage.getItem('refresh')){
                            //call the service that fires the refresh token and then gets new access token
                            RefreshToken('refresh', localStorage.getItem('refresh'))
                            .then(
                                (newaccess_response) => {
                                    let newaccess_result = newaccess_response;
                                    localStorage.clear('access');
                                    localStorage.setItem('access', newaccess_result);
                                }
                            )
                        }
                        ...
                        console.log('His token is not expired');
                    }
                }
            )
        }
  ...
  render() {
    // if state of redirect is true then the page is redirected to login page
                                        ...
                                        <table className="table ">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td className="avatar">
                                                        <div className="round-img">
                                                            <a href="mitra.cash"><img className="rounded-circle" src={require('.././images/avatar/1.jpg')} alt="" /></a>
                                                        </div>
                                                    </td>
                                                    <td> #5469 </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td className="avatar">
                                                        <div className="round-img">
                                                            <a href="mitra.cash"><img className="rounded-circle" src={require('.././images/avatar/2.jpg')} alt="" /></a>
                                                        </div>
                                                    </td>
                                                    <td> #5468 </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td className="avatar">
                                                        <div className="round-img">
                                                            <a href="mitra.cash"><img className="rounded-circle" src={require('.././images/avatar/3.jpg')} alt="" /></a>
                                                        </div>
                                                    </td>
                                                    <td> #5467 </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td className="avatar">
                                                        <div className="round-img">
                                                            <a href="mitra.cash"><img className="rounded-circle" src={require('.././images/avatar/4.jpg')} alt="" /></a>
                                                        </div>
                                                    </td>
                                                    <td> #5466 </td>
                                                ...
                                                <tr className=" pb-0">
                                                    ...
                                                    <td className="avatar pb-0">
                                                        <div className="round-img">
                                                            <a href="mitra.cash"><img className="rounded-circle" src={require('.././images/avatar/6.jpg')} alt="" /></a>
                                                        </div>
                                                    </td>
                                                    <td> #5465 </td>
                                                ...
                                                <ul>
                                                    <li>
                                                        <label>
                                                            ...
                                                            <a href="mitra.cash" className="fa fa-times">anchor</a>
                                                            <a href="mitra.cash" className="fa fa-pencil">anchor</a>
                                                            <a href="mitra.cash" className="fa fa-check">anchor</a>
                                                        </label>
                                                    </li>
                                                    <li>
                                                        <label>
                                        ...
                                        <ul>
                                            <li>
                                                <div className="msg-received msg-container">
                                                    <div className="avatar">
                                                       <img src={require('.././images/avatar/64-1.jpg')} alt="" />
                                            ...
                                            <li>
                                                <div className="msg-sent msg-container">
                                                    <div className="avatar">
                                                       <img src={require('.././images/avatar/64-2.jpg')} alt="" /> 
                                                       <div className="send-time">11.11 am</div>
                                                    </div>
                                                    <div className="msg-box">
                                                        <div className="inner-box">
